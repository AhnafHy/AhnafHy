...
| [Kubernetes Autoscaler + ECS Fargate](https://github.com/AhnafHy/k8s-autoscaler) | Python Flask app deployed across two orchestration platforms, Kubernetes with Helm and HPA, and AWS ECS Fargate with ECR and App Auto Scaling. Both scale 1→4 replicas at 50% CPU | Kubernetes, Helm, HPA, ECS Fargate, ECR, Docker, Terraform |
